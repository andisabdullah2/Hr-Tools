...
class m_help extends CI_Model {
    ...
    // insert data portal
    function insert_help($params) {
        return $this->db->insert('user_manual', $params);
    }

    // update data portal
    function update_help($params, $where) {
        return $this->db->update('user_manual', $params, $where);
    }

    // delete data portal
    function delete_help($params) {
        return $this->db->delete('user_manual', $params);
    }
    ...
    // get all group
    function get_all_user_manual_limit($params) {
        $sql = "SELECT * 
                FROM user_manual
                WHERE kategori LIKE ? 
                  AND judul LIKE ?
    ...
    // get all group
    function get_total_user_manual($params) {
    ...
    function get_user_manual_by_id($data_id) {
        $sql = "SELECT * FROM user_manual WHERE data_id = ?";
