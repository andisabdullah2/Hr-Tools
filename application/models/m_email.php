...
class m_email extends CI_Model {
    ...
    public function set_mail($email) {
        ...
        $footer = !empty($email['message']['footer']) ? $email['message']['footer'] : 'Best Regards, <br /> The Time Excelindo IT Team';
        $disclaimer = !empty($email['message']['disclaimer']) ? $email['message']['disclaimer'] : 'Anda mendapatan email ini karena menggunakan Sistem Informasi Manajemen Terpadu PT. Time Excelindo [ Jangan Dibalas ]';
        $copyright = !empty($email['message']['copyright']) ? $email['message']['copyright'] : '© ' . date('Y') . ' IT Team. PT. Time Excelindo.';
        // parse message
        ...
        $this->mail_message .= '<tr>'
                ...
                . '<tr>'
                . '<td align="left">'
                . '<img src="http://202.91.14.3/te/favicon.png" style="display:block; width:48px; height:48px" width="48" height="48" />'
                . '</td>'
                . '<td align="right">'
                . '<b style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif; font-size:24px;">PT. Time Excelindo</b>'
                . '</td>'
                . '</tr>'
                . '</tbody>'
                . '</table>'
