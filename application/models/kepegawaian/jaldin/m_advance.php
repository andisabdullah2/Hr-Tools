...
class m_advance extends CI_Model {
    ...
    public function get_advance_last_id($tahun) {
        $sql = "SELECT RIGHT(advance_id, 16)'last_number'
                FROM surat_tugas_advance
                WHERE LEFT(advance_id, 4) = ?
    ...
    function get_list_jenis_pengeluaran() {
    ...
    public function insert($params) {
        return $this->db->insert('surat_tugas_advance', $params);
    }
    ...
    public function delete($params) {
        return $this->db->delete('surat_tugas_advance', $params);
    }
