...
class pengembalian extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "keuangan/advance_jaldin/pengembalian/index.html");
        // load style
        ...
        $search = $this->tsession->userdata('search_advance_jaldin_pengembalian') ? $this->tsession->userdata('search_advance_jaldin_pengembalian') : '';
        if (!empty($search)) {
        ...
        /* start of pagination --------------------- */
        // pagination
        $config['base_url'] = site_url("keuangan/advance_jaldin/pengembalian/index/");
        $config['total_rows'] = $this->m_approval->get_total_advance_jaldin(array(7, $item_uraian));
        ...
        /* end of pagination ---------------------- */
        // get data
        $params = array(7, $item_uraian, ($start - 1), $config['per_page']);
        $this->smarty->assign("rs_id", $this->m_approval->get_list_advance_jaldin($params));
        // notification
    ...
    public function search_process() {
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session
            $this->tsession->set_userdata("search_advance_jaldin_pengembalian", $params);
        } else {
            // unset session
            $this->tsession->unset_userdata("search_advance_jaldin_pengembalian");
        }
        // redirect
        redirect("keuangan/advance_jaldin/pengembalian");
    }
    ...
    public function detail($process_id="") {
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/advance_jaldin/pengembalian/detail.html");
        // load style
        ...
        $this->smarty->assign("rs_flow", $this->m_approval->get_list_catatan_flow(array($detail['trx_id'], 22, 7)));
        // notification
        $this->tnotification->display_notification();
        $this->tnotification->display_last_field();
        // output
    ...
    public function pengajuan_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            switch ( $this->input->post('process_st', TRUE) ) {
                ...
                default:
                    // flow 6 : lpj
                    $next_flow = $this->m_approval->get_flow_by_params(array(22, 6));
                    if ( $next_flow ) {
                        //
                        ...
                        $params = array(
                            ...
                            // 'flow_revisi_id' => $next_flow['flow_id'],
