...
class kasir extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "keuangan/advance_jaldin/kasir/index.html");
        // load style
        ...
        $search = $this->tsession->userdata('search_advance_jaldin_kasir') ? $this->tsession->userdata('search_advance_jaldin_kasir') : '';
        if (!empty($search)) {
        ...
        /* start of pagination --------------------- */
        // pagination
        $config['base_url'] = site_url("keuangan/advance_jaldin/kasir/index/");
        $config['total_rows'] = $this->m_approval->get_total_advance_jaldin(array(5, $item_uraian));
    ...
    public function search_process() {
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session
            $this->tsession->set_userdata("search_advance_jaldin_kasir", $params);
        } else {
            // unset session
            $this->tsession->unset_userdata("search_advance_jaldin_kasir");
        }
        // redirect
        redirect("keuangan/advance_jaldin/kasir");
    }
    ...
    public function detail($process_id="") {
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/advance_jaldin/kasir/detail.html");
        // load style
        ...
        $this->smarty->assign("rs_flow", $this->m_approval->get_list_flow_plan(array($detail['trx_id'], 22, 5)));
        // notification
        $this->tnotification->display_notification();
        $this->tnotification->display_last_field();
        // output
    ...
    public function pengajuan_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            // default redirect
            redirect("keuangan/advance_jaldin/kasir/detail/".$this->input->post('process_id', TRUE));
        }
        // default redirect
        redirect("keuangan/advance_jaldin/kasir");
    }
