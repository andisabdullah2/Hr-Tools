...
class pengembalian extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "keuangan/advance_umum/pengembalian/index.html");
        // load style
        ...
        $search = $this->tsession->userdata('search_advance_umum_pengembalian') ? $this->tsession->userdata('search_advance_umum_pengembalian') : '';
        if (!empty($search)) {
        ...
        /* start of pagination --------------------- */
        // pagination
        $config['base_url'] = site_url("keuangan/advance_umum/pengembalian/index/");
        $config['total_rows'] = $this->m_approval->get_total_advance_umum(array(7, $item_uraian));
    ...
    public function search_process() {
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session
            $this->tsession->set_userdata("search_advance_umum_pengembalian", $params);
        } else {
            // unset session
            $this->tsession->unset_userdata("search_advance_umum_pengembalian");
        }
        // redirect
        redirect("keuangan/advance_umum/pengembalian");
    }
    ...
    public function detail($process_id="") {
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/advance_umum/pengembalian/detail.html");
        // load style
        ...
        $this->smarty->assign("rs_flow", $this->m_approval->get_list_catatan_flow(array($detail['trx_id'], 21, 7)));
        // notification
        $this->tnotification->display_notification();
        $this->tnotification->display_last_field();
        // output
