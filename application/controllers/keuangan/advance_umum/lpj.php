...
class lpj extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "keuangan/advance_umum/lpj/index.html");
        // load style
        ...
        $search = $this->tsession->userdata('search_advance_umum_lpj') ? $this->tsession->userdata('search_advance_umum_lpj') : '';
        if (!empty($search)) {
        ...
        /* start of pagination --------------------- */
        // pagination
        $config['base_url'] = site_url("keuangan/advance_umum/lpj/index/");
        $config['total_rows'] = $this->m_approval->get_total_advance_umum_lpj(array(6, $item_uraian));
        ...
        $this->smarty->assign("rs_id", $this->m_approval->get_list_advance_umum_lpj($params));
        // notification
    ...
    public function search_process() {
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session
            $this->tsession->set_userdata("search_advance_umum_lpj", $params);
        } else {
            // unset session
            $this->tsession->unset_userdata("search_advance_umum_lpj");
        }
        // redirect
        redirect("keuangan/advance_umum/lpj");
    }
    ...
    public function detail($process_id="") {
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/advance_umum/lpj/detail.html");
        // load library
        ...
        $this->smarty->assign("flow", $this->m_approval->get_flow_plan(array($detail['trx_id'], 21, 7)));
        // notification
        $this->tnotification->display_notification();
        $this->tnotification->display_last_field();
        // output
    ...
    public function lpj_add_process() {
        ...
        // default redirect
        redirect("keuangan/advance_umum/lpj/detail/".$process_id);
    }
    ...
    public function pengajuan_process($process_id = "") {
        ...
        // flow 7
        $next_flow = $this->m_approval->get_flow_by_params(array(21, 7));
        if ( $next_flow ) {
