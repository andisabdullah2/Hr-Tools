...
class keuangan extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "keuangan/pembelian_lebih_satu_juta/keuangan/index.html");
        // search
        $search = $this->tsession->userdata("pembelian_lebih_satu_juta_keuangan_search");
        ...
        // pagination
        $config['base_url'] = site_url("keuangan/pembelian_lebih_satu_juta/keuangan/index/");
    ...
    public function search_process(){
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session search
            $this->tsession->set_userdata("pembelian_lebih_satu_juta_keuangan_search", $params);
        } else{
            // unset session search
            $this->tsession->unset_userdata("pembelian_lebih_satu_juta_keuangan_search");
        }
        // default redirect
        redirect("keuangan/pembelian_lebih_satu_juta/keuangan");
    }
    ...
    public function detail($trx_id = ''){
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/pembelian_lebih_satu_juta/keuangan/detail.html");
        // load style
    ...
    public function pengajuan_process(){
        ...
        if ($this->tnotification->run() == TRUE) {
            ...
            if (!$this->m_approval->update_trx_advance_process($params, $where)) {
                ...
                redirect('keuangan/pembelian_lebih_satu_juta/keuangan/detail/' . $trx_id);
            }
