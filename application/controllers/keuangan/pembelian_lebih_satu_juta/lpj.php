...
class lpj extends ApplicationBase {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // load model
        $this->load->model('keuangan/pembelian_lebih_satu_juta/m_lpj');
        // load library
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "keuangan/pembelian_lebih_satu_juta/lpj/index.html");
        // search
        $search = $this->tsession->userdata("pembelian_lebih_satu_juta_lpj_search");
        ...
        // pagination
        $config['base_url'] = site_url("keuangan/pembelian_lebih_satu_juta/lpj/index/");
    ...
    public function search_process(){
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session search
            $this->tsession->set_userdata("pembelian_lebih_satu_juta_lpj_search", $params);
        } else{
            // unset session search
            $this->tsession->unset_userdata("pembelian_lebih_satu_juta_lpj_search");
        }
        // default redirect
        redirect("keuangan/pembelian_lebih_satu_juta/lpj");
    }
    ...
    public function detail($trx_id = ''){
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/pembelian_lebih_satu_juta/lpj/detail.html");
        // load style
    ...
    public function pengajuan_process($trx_id = ''){
        ...
        if (empty($this->m_lpj->get_list_lpj_by_trx_id($trx_id))) {
            ...
            redirect('keuangan/pembelian_lebih_satu_juta/lpj/detail/' . $trx_id);
        }
