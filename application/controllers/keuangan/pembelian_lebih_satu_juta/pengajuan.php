...
class pengajuan extends ApplicationBase {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // load model
        $this->load->model('keuangan/pembelian_lebih_satu_juta/m_pengajuan');
        // load library
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "keuangan/pembelian_lebih_satu_juta/pengajuan/index.html");
        // search
        $search = $this->tsession->userdata("pembelian_lebih_satu_juta_search");
        ...
        // pagination
        $config['base_url'] = site_url("keuangan/pembelian_lebih_satu_juta/pengajuan/index/");
    ...
    public function search_process(){
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session search
            $this->tsession->set_userdata("pembelian_lebih_satu_juta_search", $params);
        } else{
            // unset session search
            $this->tsession->unset_userdata("pembelian_lebih_satu_juta_search");
        }
        // default redirect
        redirect("keuangan/pembelian_lebih_satu_juta/pengajuan");
    }
    ...
    public function add(){
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/pembelian_lebih_satu_juta/pengajuan/add.html");
    ...
    public function add_process(){
        ...
        if ($this->tnotification->run() == TRUE) {
            ...
            if (!$this->m_pengajuan->insert_trx_advance($params)) {
                ...
                redirect('keuangan/pembelian_lebih_satu_juta/pengajuan/add');
            }
            ...
            // redirect
            redirect('keuangan/pembelian_lebih_satu_juta/pengajuan/item/' . $trx_id);
        } else {
            // default error
    ...
    public function edit($trx_id = ''){
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/pembelian_lebih_satu_juta/pengajuan/edit.html");
        // get data
    ...
    public function edit_process(){
        ...
        if ($this->tnotification->run() == TRUE) {
            ...
            if (!$this->m_pengajuan->update_trx_advance($params,$where)) {
                // error update
                $this->tnotification->sent_notification('error', 'Data pengajuan gagal disimpan');
                redirect('keuangan/pembelian_lebih_satu_juta/pengajuan/edit/' . $trx_id);
            }
    ...
    public function delete($trx_id="") {
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/pembelian_lebih_satu_juta/pengajuan/delete.html");
        // get data
        $detail = $this->m_pengajuan->get_trx_advance_by_id(array($this->group_id,$trx_id));
        // check data
        if (empty($detail)) {
    ...
    public function delete_process(){
        ...
        if ($this->tnotification->run() == TRUE) {
            ...
            if (!$this->m_pengajuan->delete_trx_advance($where)) {
                ...
                redirect('keuangan/pembelian_lebih_satu_juta/pengajuan/delete/' . $trx_id);        
            }
            // success
            $this->tnotification->delete_last_field();
    ...
    public function item($trx_id="") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "keuangan/pembelian_lebih_satu_juta/pengajuan/item.html");
        // get data
        $detail = $this->m_pengajuan->get_trx_advance_by_id(array($this->group_id,$trx_id));
        // check data
        if (empty($detail)) {
    ...
    public function download($trx_id = ''){
        ...
        // load template excel
        $filepath = "resource/doc/template/FM_GA_03_FORM_PERMINTAAN_PEMBELIAN_DIATAS1JUTA.xlsx";
        ...
        // set
        $objWorksheet->setCellValue('C' . $row_ttd, $detail['send_name']);
        // file_name
        $file_name = "PERMINTAAN_PEMBELIAN_BARANG_DIATAS_1_JUTA_" . str_replace('-', '_', strtoupper($detail['advance_tanggal'])) . '_' . str_replace(' ', '_', $detail['struktur_singkatan']);
        //--
