...
class kasir extends ApplicationBase {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // load model
        $this->load->model('keuangan/pembelian_kurang_satu_juta/m_kasir');
        // load library
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "keuangan/pembelian_kurang_satu_juta/kasir/index.html");
        // search
        $search = $this->tsession->userdata("pembelian_kurang_satu_juta_kasir_search");
        ...
        // pagination
        $config['base_url'] = site_url("keuangan/pembelian_kurang_satu_juta/kasir/index/");
    ...
    public function search_process(){
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session search
            $this->tsession->set_userdata("pembelian_kurang_satu_juta_kasir_search", $params);
        } else{
            // unset session search
            $this->tsession->unset_userdata("pembelian_kurang_satu_juta_kasir_search");
        }
        // default redirect
        redirect("keuangan/pembelian_kurang_satu_juta/kasir");
    }
    ...
    public function detail($trx_id = ''){
        ...
        // set template content
        $this->smarty->assign("template_content", "keuangan/pembelian_kurang_satu_juta/kasir/detail.html");
        // load style
    ...
    public function pengajuan_process(){
        ...
        if ($this->tnotification->run() == TRUE) {
            ...
            if (!$this->m_kasir->update_trx_advance_process($params, $where)) {
                ...
                redirect('keuangan/pembelian_kurang_satu_juta/kasir/detail/' . $trx_id);
            }
