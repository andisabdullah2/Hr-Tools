...
class dirut extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "project/rka_manajemen/dirut/index.html");
        // load style
        ...
        $search = $this->tsession->userdata('search_rka_manajemen_dirut') ? $this->tsession->userdata('search_rka_manajemen_dirut') : '';
        if (!empty($search)) {
        ...
        /* start of pagination --------------------- */
        // pagination
        $config['base_url'] = site_url("project/rka_manajemen/dirut/index/");
        $config['total_rows'] = $this->m_approval->get_total_rka_manajemen(array(4, $project_alias, $process_st));
        ...
        /* end of pagination ---------------------- */
        // get data
        $params = array(4, $project_alias, $process_st, ($start - 1), $config['per_page']);
    ...
    public function search_process() {
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session
            $this->tsession->set_userdata("search_rka_manajemen_dirut", $params);
        } else {
            // unset session
            $this->tsession->unset_userdata("search_rka_manajemen_dirut");
        }
        // redirect
        redirect("project/rka_manajemen/dirut");
    }
    ...
    public function detail($process_id="") {
        ...
        // set template content
        $this->smarty->assign("template_content", "project/rka_manajemen/dirut/detail.html");
        // load style
