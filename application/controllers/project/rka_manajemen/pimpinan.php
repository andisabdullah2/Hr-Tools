...
class pimpinan extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "project/rka_manajemen/pimpinan/index.html");
        // load style
        ...
        $search = $this->tsession->userdata('search_rka_manajemen_pimpinan') ? $this->tsession->userdata('search_rka_manajemen_pimpinan') : '';
        if (!empty($search)) {
        ...
        /* start of pagination --------------------- */
        // pagination
        $config['base_url'] = site_url("project/rka_manajemen/pimpinan/index/");
        $config['total_rows'] = $this->m_approval->get_total_rka_manajemen(array(2, $project_alias, $process_st));
        ...
        /* end of pagination ---------------------- */
        // get data
        $params = array(2, $project_alias, $process_st, ($start - 1), $config['per_page']);
    ...
    public function search_process() {
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // set session
            $this->tsession->set_userdata("search_rka_manajemen_pimpinan", $params);
        } else {
            // unset session
            $this->tsession->unset_userdata("search_rka_manajemen_pimpinan");
        }
        // redirect
        redirect("project/rka_manajemen/pimpinan");
    }
    ...
    public function detail($process_id="") {
        ...
        // set template content
        $this->smarty->assign("template_content", "project/rka_manajemen/pimpinan/detail.html");
        // load style
    ...
    public function pengajuan_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            switch ( $this->input->post('process_st', TRUE) ) {
                case 'approve':
                    // flow 3
                    $flow_3 = $this->m_approval->get_flow_by_params(array(15, 3));
                    if ( $flow_3 ) {
