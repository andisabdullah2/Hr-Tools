...
class groups extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "settings/sistem/groups/index.html");
        // get data
        $this->smarty->assign("rs_id", $this->m_settings->get_all_group());
        // notification
    ...
    public function add() {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/groups/add.html");
    ...
    public function edit($group_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/groups/edit.html");
        // get data
    ...
    public function delete($group_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/groups/delete.html");
        // get data
        $result = $this->m_settings->get_group_by_id($group_id);
        // check
        if (empty($result)) {
