...
class roles extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "settings/sistem/roles/index.html");
        // load javascript
        ...
        // get data
        $this->smarty->assign("rs_id", $this->m_settings->get_all_roles(array($role_nm, $group_id)));
        //groups
    ...
    public function add() {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/roles/add.html");
        // load javascript
        $this->smarty->load_javascript("resource/themes/default/plugins/select2/dist/js/select2.min.js");
        // get data
        $this->smarty->assign("rs_group", $this->m_settings->get_all_group());
    ...
    public function edit($role_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/roles/edit.html");
        // load javascript
        $this->smarty->load_javascript("resource/themes/default/plugins/select2/dist/js/select2.min.js");
        // get data
        $this->smarty->assign("rs_group", $this->m_settings->get_all_group());
    ...
    public function delete($role_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/roles/delete.html");
        // get data
        $result = $this->m_settings->get_detail_role_by_id($role_id);
        // check
        if (empty($result)) {
