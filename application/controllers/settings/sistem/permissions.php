...
class permissions extends ApplicationBase
{
    ...
    public function index()
    {
        ...
        $this->smarty->assign("template_content", "settings/sistem/permissions/index.html");
        // load javascript
    ...
    public function access_update($role_id = "")
    {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/permissions/access_update.html");
        // load javascript
        $this->smarty->load_javascript("resource/themes/default/plugins/select2/dist/js/select2.min.js");
        // get detail role
    ...
    public function filter_portal_process($role_id = "")
    {
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            // unset session
            $this->tsession->unset_userdata("filter_portal");
        }
        // redirect
