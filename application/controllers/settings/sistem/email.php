...
class email extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "settings/sistem/email/index.html");
        // get data
        $this->smarty->assign("rs_email", $this->m_email->get_list_email());
        // notification
    ...
    public function add() {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/email/add.html");
        // load javascript
    ...
    public function edit($email_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/email/edit.html");
        // get data
    ...
    public function delete($email_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/email/delete.html");
        // get data
        $result = $this->m_email->get_email_by_id($email_id);
        // check
        if (empty($result)) {
    ...
    public function test_email($email_id = '') {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/email/test.html");
        // load javascript
        $this->smarty->load_javascript("resource/themes/default/plugins/ckeditor/ckeditor.js");
        $this->smarty->load_javascript("resource/themes/default/plugins/ckeditor/adapters/jquery.js");
        // get data
        $result = $this->m_email->get_email_by_id($email_id);
        // check
        if (empty($result)) {
