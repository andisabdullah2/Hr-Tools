...
class menu extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "settings/sistem/menu/index.html");
        // get data
    ...
    public function navigation($portal_id = '') {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/menu/navigation.html");
        // load javascript
        ...
        $search = $this->tsession->userdata('search_menu');
        // search parameters
        if (!empty($search)) {
        ...
        $this->smarty->assign("rs_parent", $rs_parent);
        // notification
        $this->tnotification->display_notification();
        $this->tnotification->display_last_field();
        // output
    ...
    public function search_process($portal_id = "") {
        ...
        if ($this->input->post('save') == "Cari") {
            ...
            //       print_r($params);exit;
            // set session
            $this->tsession->set_userdata("search_menu", $params);
        } else {
            // unset session
            $this->tsession->unset_userdata("search_menu");
        }
        // redirect
    ...
    public function add($portal_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/menu/add.html");
        // load javascript
        $this->smarty->load_javascript("resource/themes/default/plugins/select2/dist/js/select2.min.js");
        // get data portal
        $portal = $this->m_settings->get_portal_by_id($portal_id);
    ...
    public function edit($portal_id = '', $nav_id = '') {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/menu/edit.html");
        // load javascript
        $this->smarty->load_javascript("resource/themes/default/plugins/select2/dist/js/select2.min.js");
        // get data portal
        $portal = $this->m_settings->get_portal_by_id($portal_id);
    ...
    public function delete($portal_id = '', $nav_id = '') {
        ...
        // set template content
        $this->smarty->assign("template_content", "settings/sistem/menu/hapus.html");
        // get data portal
        $portal = $this->m_settings->get_portal_by_id($portal_id);
        if (empty($portal)) {
            redirect('settings/sistem/menu');
