<?php
/* Smarty version 3.1.30, created on 2021-09-14 14:14:30
  from "/opt/lampp/htdocs/te-tools/application/views/kepegawaian/master/hari_libur/list.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_61404bd6ad76e5_74852304',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6edc8975a9a24b44ed33248c64a24c2d5e8c1726' => 
    array (
      0 => '/opt/lampp/htdocs/te-tools/application/views/kepegawaian/master/hari_libur/list.html',
      1 => 1631071316,
      2 => 'file',
    ),
  ),
...
function content_61404bd6ad76e5_74852304 (Smarty_Internal_Template $_smarty_tpl) {
?>
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tool">
                        <ul class="nav nav-xs">
                            <li class="nav-item">
                                <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->site_url('kepegawaian/master/hari_libur/add/');?>
" class="btn btn-outline b-primary text-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                ...
                <div class="box-search clearfix">
                    <form action="<?php echo $_smarty_tpl->tpl_vars['config']->value->site_url('kepegawaian/master/hari_libur/proses_cari/');?>
" method="post">
                        <div class="row">
                            <div class="col-md-12">
...
if ($_prefixVariable12 == "12") {?>selected="selected"<?php }?>>Desember</option>
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group">
                                                <input tabindex="1" maxlength="4" size="4" type="number" class="form-control" data-plugin="datepicker" data-option="{format: 'yyyy', autoclose:true,clearBtn: true, viewMode:'years',minViewMode:'years'}" placeholder="Tahun" name="tahun" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['search']->value['tahun'])===null||$tmp==='' ? '' : $tmp);?>
...
.</td>
                                <td align="center"><?php echo $_smarty_tpl->tpl_vars['dtm']->value->get_full_date((($tmp = @$_smarty_tpl->tpl_vars['result']->value['libur_tanggal'])===null||$tmp==='' ? '' : $tmp));?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['result']->value['libur_jenis'];?>
</td>                                
                                <td align="center"><?php echo $_smarty_tpl->tpl_vars['result']->value['libur_judul'];?>
</td>
                                <td align="center"><?php echo $_smarty_tpl->tpl_vars['result']->value['libur_keterangan'];?>
</td>
                                <td align="center">
                                        <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->site_url(('kepegawaian/master/hari_libur/edit/').($_smarty_tpl->tpl_vars['result']->value['libur_id']));?>
" class="btn btn-xs white text-success"><i class="fa fa-edit"></i></a>
                                        <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->site_url(('kepegawaian/master/hari_libur/delete/').($_smarty_tpl->tpl_vars['result']->value['libur_id']));?>
