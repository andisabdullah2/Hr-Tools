<?php
/* Smarty version 3.1.30, created on 2021-09-14 16:36:19
  from "/opt/lampp/htdocs/te-tools/application/views/kepegawaian/master/hari_libur/add.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_61406d13621f60_52422436',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0fd9ccc71f936713946e461e5de3c1a4a628e848' => 
    array (
      0 => '/opt/lampp/htdocs/te-tools/application/views/kepegawaian/master/hari_libur/add.html',
      1 => 1631071316,
      2 => 'file',
    ),
  ),
...
function content_61406d13621f60_52422436 (Smarty_Internal_Template $_smarty_tpl) {
?>
        ...
        <div class="col-12">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Tambah Data Hari Libur</h4>
                    <div class="box-tool">
                        <ul class="nav nav-xs">
                            <li class="nav-item">
...
" class="btn btn-outline b-primary text-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                ...
                <!-- /.box-header -->
                <form action="<?php echo $_smarty_tpl->tpl_vars['config']->value->site_url('kepegawaian/master/hari_libur/add_process');?>
...
if ($_prefixVariable2 == "KANTOR") {?>selected="selected"<?php }?>>Kantor</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" name="libur_judul" type="text" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['jabatan_nama'])===null||$tmp==='' ? '' : $tmp);?>
