<?php
/* Smarty version 3.1.30, created on 2021-09-14 08:21:10
  from "/opt/lampp/htdocs/te-tools/application/views/kepegawaian/master/kuota_cuti/edit.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_613ff90656f947_60709827',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fbed7c9a8dfe4d01c5986ff6e7e0e8c65dde9c2e' => 
    array (
      0 => '/opt/lampp/htdocs/te-tools/application/views/kepegawaian/master/kuota_cuti/edit.html',
      1 => 1631071316,
      2 => 'file',
    ),
  ),
...
function content_613ff90656f947_60709827 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
        ...
        <div class="col-12">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Edit Data Kuota Cuti</h4>
                    <div class="box-tool">
                        <ul class="nav nav-xs">
                            <li class="nav-item">
...
" class="btn btn-outline b-primary text-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                ...
                <div class="box-body">  
                        <div class="tab-content" style="margin-top:0;">
                                <form action="<?php echo $_smarty_tpl->tpl_vars['config']->value->site_url('kepegawaian/master/kuota_cuti/edit_process');?>
...
?>
                                                ...
                                                <input type="hidden" name="user_id_old" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['user_id'])===null||$tmp==='' ? '' : $tmp);?>
"/>
                                                <input type="hidden" name="tahun_old" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['tahun'])===null||$tmp==='' ? '' : $tmp);?>
"/>
                                                <input type="hidden" name="jenis_id_old" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['jenis_id'])===null||$tmp==='' ? '' : $tmp);?>
"/>
...
?>
                                                ...
                                                <div class="form-group row">
                                                        ...
                                                        <div class="col-md-2">
                                                                ...
                                                                <input tabindex="1" maxlength="4" size="4" type="number" class="form-control" data-plugin="datepicker" data-option="{format: 'yyyy', clearBtn: true, viewMode:'years',minViewMode:'years'}" placeholder="Tahun" name="tahun" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['tahun'])===null||$tmp==='' ? '' : $tmp);?>
...
if ($_prefixVariable2 == $_smarty_tpl->tpl_vars['result']->value['jenis_id']) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['data']->value['jenis_cuti'];?>
</option>
                                                                        <?php
}
}
